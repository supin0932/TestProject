...
import ultilities.Report.ExtentTestManager;
...
import static ultilities.Report.ExtentManager.getExtentReports;
...
public class ReportListener implements ITestListener {
    ...
    public void onTestFailure(ITestResult iTestResult) {
        Log.warn(getTestName(iTestResult) + " test is failed.");
    ...
    public void onTestFailedButWithinSuccessPercentage(ITestResult iTestResult) {
        Log.warn("Test failed but it is in defined success ratio " + getTestName(iTestResult));
